Shader  "Custom/perlin_ascii_art" {
	Properties {
		...
		_PerlinCharAlpha ("Alpha between Perlin and Char", Float) = 0.5
	}
	...
	SubShader {
		...
		void surf (Input IN, inout SurfaceOutput o) {
			...
			float4 c = PerlinNormal(float3(uv, IN.pos.z), _Octaves, _Offset, _Frequency, _Amplitude, _Lacunarity, _Persistence);;
			...
			o.Albedo = lerp(gray, t, _PerlinCharAlpha);
			o.Alpha = 1.0;
		}
		ENDCG
	}
